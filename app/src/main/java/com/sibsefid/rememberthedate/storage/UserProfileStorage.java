package com.sibsefid.rememberthedate.storage;
...
public class UserProfileStorage {
    ...
    public void storeUserProfile(String name, String email, Bitmap avatar, String phone) {
    ...
    public UserProfile getProfile() {
        ...
        userProfile.setmPhone(mStorage.getString(USER_phone, ""));

...
public class AppointmentAdapter extends RecyclerView.Adapter<AppointmentAdapter.MyViewHolder> {
    ...
    public AppointmentAdapter(Context mContext, ArrayList<DAppointmentListModel.DAppointmentBean> mList_Status, SaveRequestedData.OnSaveRequestedDataCallBackListener dataCallBackListener) {
    ...
    public void onBindViewHolder(AppointmentAdapter.MyViewHolder holder, final int position) {
        ...
        holder.mDate.setText(mContext.getResources().getString(R.string.on) + " " + holder.mItem.getAppointDate());
        holder.mAtTime.setText(mContext.getResources().getString(R.string.at) + " " + holder.mItem.getAppointTime() + " ");
        ...
        holder.mAcceptsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                mItem.setAppointmentid(bean.getAppointId());
                mItem.setAction("3");
                mItem.setDoctorname(bean.getDoctorname());
                mItem.setPatientemail(bean.getPatient_Email());

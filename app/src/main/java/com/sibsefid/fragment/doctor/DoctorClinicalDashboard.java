 ...
 */
public class DoctorClinicalDashboard extends Fragment {
    ...
    public DoctorClinicalDashboard() {
        // Required empty public constructor
    }


    public static DoctorClinicalDashboard newInstance(String param1) {
        DoctorClinicalDashboard fragment = new DoctorClinicalDashboard();

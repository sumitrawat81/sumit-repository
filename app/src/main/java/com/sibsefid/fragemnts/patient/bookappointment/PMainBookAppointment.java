 ...
 */
public class PMainBookAppointment extends Fragment {

    public static final String TAG = "PMainBookAppointment";
    private static PMainBookAppointment appointment;
    private TabLayout tabLayout = null;
    private ViewPager mPager;
    private PatientActivity activity;

    public static PMainBookAppointment getInstance() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PReasonForVisit(), getResources().getString(R.string.reson_for_visit));
        adapter.addFragment(new PChoosePharmacy(), getResources().getString(R.string.choose_pharmcy));
        adapter.addFragment(new PPayment(), getResources().getString(R.string.payment));

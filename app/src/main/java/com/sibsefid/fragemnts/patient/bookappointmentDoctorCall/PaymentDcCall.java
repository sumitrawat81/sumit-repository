 ...
 */
public class PaymentDcCall extends Fragment implements View.OnClickListener {
    ...
    private static PaymentDcCall pPayment;
    ...
    private ChoosePharmacyDrCall pharmacy;

    public static PaymentDcCall getInstance() {
    ...
    public void setDectorFee() {
        if (mDoctorFee != null && getActivity() != null) {
            pharmacy = ChoosePharmacyDrCall.getInstance();

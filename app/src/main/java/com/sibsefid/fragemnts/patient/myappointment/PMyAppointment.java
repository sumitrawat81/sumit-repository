 ...
 */
public class PMyAppointment extends Fragment {

    public static final String TAG = "PMyAppointment";
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PPastAppointment(), getResources().getString(R.string.my_past_appointment));
        adapter.addFragment(new PFutureAppointment(), getResources().getString(R.string.my_future_appointment));

...
/**
 * Created by ubuntu on 4/11/16.
 */
public class PatientClinicalDashboard extends Fragment {
    ...
    public PatientClinicalDashboard() {
        // Required empty public constructor
    }


    public static PatientClinicalDashboard newInstance(String param1) {
        PatientClinicalDashboard fragment = new PatientClinicalDashboard();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.doctor_clinical_dashboard, container, false);

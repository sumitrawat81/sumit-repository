 ...
 */
public class PCheckSkin extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.p_check_skin, container, false);
    ...
    public void showCustomDialog() {
        ...
        dialog.setContentView(R.layout.add_skin_result_dialog);
                ...
                if (Utils.isDeviceOnline(getActivity())) {
                    ...
                    if (!TextUtils.isEmpty(mSubject.getText().toString().trim()) && (!TextUtils.isEmpty(mBrowseFile.getText().toString()))) {
                        ...
                        RestAdapter.getAdapter()
                                .addSetSkinManually(RetrofitUtils.createMultipartRequest(requestValuePairsMap),
                                        RetrofitUtils.createFilePart(KeyValues.ARG_P_SkinFile,

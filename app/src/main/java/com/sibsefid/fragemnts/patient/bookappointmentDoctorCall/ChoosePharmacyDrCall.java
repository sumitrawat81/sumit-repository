 ...
 */
public class ChoosePharmacyDrCall extends Fragment implements View.OnClickListener {

    public static final String TAG = "ChoosePharmacyDrCall";
    private static ChoosePharmacyDrCall pharmacy;
            ...
            if (getActivity() != null) {
                ...
                if (response.isSuccessful()) {
                    if (response.body().isSuccess() && response.body().getData() != null && response.body().getData().getBookingSummary() != null) {
                        ...
                        PaymentDcCall.getInstance().setDectorFee();
                        PMainBookAppDocCall.getInstance().getmPager().setCurrentItem(2);
                    } else {
    ...
    public static ChoosePharmacyDrCall getInstance() {
        return pharmacy;
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.mContinueBtn:
                ...
                if (Utils.isDeviceOnline(getActivity())) {
                    ...
                    String dateNew = postModel.getDate() + " " + postModel.getTime();
                    ...
                    requestValuePairsMap.put(KeyValues.ARG_PatientPhone, postModel.getPatientPhone());
                    ...
                    if (postModel.getImage_uri().length() > 0) {
                        ...
                        RestAdapter.getAdapter().bookingAppointmentDoctorForCall(loginDetails.getUser_seq(), postModel.getReason(), postModel.getComment(), postModel.getPatientPhone(), current_Time_Zone, postModel.getImage_uri(),langOpted).enqueue(bookAppointmentCallback);
                    }

 ...
 */
public class HeightDetailFragment extends Fragment {
    ...
    private List<PatientHeightModel.DataBean> pHeightDetails;


    Callback<PatientHeightModel> detailsCallback = new Callback<PatientHeightModel>() {
        @Override
        public void onResponse(Call<PatientHeightModel> call, Response<PatientHeightModel> response) {
            if (getActivity() != null) {
                showProgress(false);
        ...
        @Override
        public void onFailure(Call<PatientHeightModel> call, Throwable t) {
            if (getActivity() != null) {
                showProgress(false);
            }
        }
    ...
    public HeightDetailFragment() {

    }

    private void updateUi() {

        //listMember.setAdapter(new HeightDetailFragmentAdapter(pHeightDetails));
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.height_detail_fragment, container, false);

        initiateView(view);

        if (Utils.isDeviceOnline(getActivity())) {
            showProgress(true);
            // RestAdapter.getAdapter().GetPatientHeight(details.getUser_seq()).enqueue(detailsCallback);
        }
    ...
    private void initiateView(View view) {
        ...
        String url = ApiUrls.BASE_URL_WebView+"height.aspx?patientid=" + details.getUser_seq();

 ...
 */
public class PComposeMessageMsg extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pcompose_message_msg, container, false);
        initiateUi(view);
        ...
        if (Utils.isDeviceOnline(getActivity())) {
            ...
            RestAdapter.getAdapter().getComposerMsgTo("D0001", details.getUser_seq(),selLangToSend).enqueue(composeToPModelCallback);
        }
